    ...
    return (
        <>
            <SEO
                ...
                description="Informasi cuaca terkini dan rekomendasi pertanian untuk wilayah Ternate dan sekitarnya. Dapatkan prakiraan cuaca untuk perencanaan bertani."
                keywords="prakiraan cuaca, cuaca pertanian, cuaca ternate, ramalan cuaca, rekomendasi bertani"
                url="/cuaca"
            />
